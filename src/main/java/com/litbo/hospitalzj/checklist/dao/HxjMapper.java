...
public interface HxjMapper {
    ...
    @Insert("    insert into hxj_template ( bhjdzk_yxz, jyzk_yxz, \n" +
            ...
            "      qztqpl_zdyc, xrynd_hxjsdz1, xrynd_hxjsdz2, \n" +
            "      xrynd_hxjsdz3, xrynd_hxjsdz4, xrynd_hxjsdz5, \n" +
            "      xrynd_zdyc, xqfzyl_hxjsdz1, xqfzyl_hxjsdz2, \n" +
            "      xqfzyl_hxjsdz3, xqfzyl_hxjsdz4, xqfzyl_hxjsdz5, \n" +
            "      xqfzyl_zdyc1, xqfzyl_zdyc2, hqmzy_hxjsdz1, \n" +
            "      hqmzy_hxjsdz2, hqmzy_hxjsdz3, hqmzy_hxjsdz4, \n" +
            "      hqmzy_hxjsdz5, hqmzy_zdyc, type)" +
            ...
            "      #{qztqplZdyc,jdbcType=VARCHAR}, #{xryndHxjsdz1,jdbcType=VARCHAR}, #{xryndHxjsdz2,jdbcType=VARCHAR}, \n" +
            "      #{xryndHxjsdz3,jdbcType=VARCHAR}, #{xryndHxjsdz4,jdbcType=VARCHAR}, #{xryndHxjsdz5,jdbcType=VARCHAR}, \n" +
            "      #{xryndZdyc,jdbcType=VARCHAR}, #{xqfzylHxjsdz1,jdbcType=VARCHAR}, #{xqfzylHxjsdz2,jdbcType=VARCHAR}, \n" +
            "      #{xqfzylHxjsdz3,jdbcType=VARCHAR}, #{xqfzylHxjsdz4,jdbcType=VARCHAR}, #{xqfzylHxjsdz5,jdbcType=VARCHAR}, \n" +
            "      #{xqfzylZdyc1,jdbcType=VARCHAR}, #{xqfzylZdyc2,jdbcType=VARCHAR},  #{hqmzyHxjsdz1,jdbcType=VARCHAR}, \n" +
            "      #{hqmzyHxjsdz2,jdbcType=VARCHAR}, #{hqmzyHxjsdz3,jdbcType=VARCHAR}, #{hqmzyHxjsdz4,jdbcType=VARCHAR}, \n" +
            "      #{hqmzyHxjsdz5,jdbcType=VARCHAR}, #{hqmzyZdyc,jdbcType=VARCHAR}, #{type,jdbcType=INTEGER})")
    ...
    @Insert("insert into hxj (jcyq_id, eq_id, \n" +
            ...
            "      xqfzyl_scwc_value5,  xqfzyl_zdyc1, xqfzyl_zdyc2,\n" +
            ...
            "      hqmzy_zdyc1, hqmzy_zdyc2, hqmzy_result, \n" +
            "      fwczdykg, brhlgybhgn, jygn, \n" +
            "      jysx, qdylsxxbj, bjsz, \n" +
            "      ddbj, hxplsxxbj, nbdy, \n" +
            "      qybj, yndsxxbj, wtjyfcs, \n" +
            "      fztqlsxxbj, hqmzysxxbj, tqzxbj, \n" +
            "      type)\n" +
            ...
            "      #{hqmzyZdyc1,jdbcType=VARCHAR}, #{hqmzyZdyc2,jdbcType=VARCHAR}, #{hqmzyResult,jdbcType=VARCHAR}, \n" +
            "      #{fwczdykg,jdbcType=VARCHAR}, #{brhlgybhgn,jdbcType=VARCHAR}, #{jygn,jdbcType=VARCHAR}, \n" +
            "      #{jysx,jdbcType=VARCHAR}, #{qdylsxxbj,jdbcType=VARCHAR}, #{bjsz,jdbcType=VARCHAR}, \n" +
            "      #{ddbj,jdbcType=VARCHAR}, #{hxplsxxbj,jdbcType=VARCHAR}, #{nbdy,jdbcType=VARCHAR}, \n" +
            "      #{qybj,jdbcType=VARCHAR}, #{yndsxxbj,jdbcType=VARCHAR}, #{wtjyfcs,jdbcType=VARCHAR}, \n" +
            "      #{fztqlsxxbj,jdbcType=VARCHAR}, #{hqmzysxxbj,jdbcType=VARCHAR}, #{tqzxbj,jdbcType=VARCHAR}, \n" +
