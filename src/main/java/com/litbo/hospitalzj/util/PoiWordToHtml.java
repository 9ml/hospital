...
//    HttpServletRequest request,
    public static String PoiWord07ToHtml (String url) throws IOException {
        url= url.replaceAll("/","\\\\") ;
        String hname = url.split("\\.")[0].split("\\\\")[2];
        String pjpath = System.getProperty("user.dir");
        String path= pjpath+"\\zdhtml\\"+hname;
...
//    }
    ...
    public static  String Word2003ToHtml(String url) throws IOException, TransformerException, ParserConfigurationException {
        String pjpath = System.getProperty("user.dir");
        url= url.replaceAll("/","\\\\") ;
        String hname = url.split("\\.")[0].split("\\\\")[2];
        System.out.println("ceshi"+url);
        final String imagepath = pjpath + "/zdhtml/image/"+hname+"/";//解析时候如果doc文件中有图片  图片会保存在此路径

        String filepath = pjpath + "\\static_file\\";
        String htmlPath = pjpath + "\\zdhtml\\";
        String fileName = hname + ".doc";
        String htmlName = hname + ".html";
